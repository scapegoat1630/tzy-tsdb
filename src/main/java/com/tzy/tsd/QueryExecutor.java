...
import com.tzy.core.DataPoint;
import com.tzy.core.DataPoints;
import com.tzy.core.QueryException;
import com.tzy.core.TSDB;
import com.tzy.core.TSQuery;
import com.tzy.core.TSSubQuery;
import com.tzy.core.Tags;
import com.tzy.query.expression.ExpressionDataPoint;
import com.tzy.query.expression.ExpressionIterator;
import com.tzy.query.expression.NumericFillPolicy;
import com.tzy.query.expression.TimeSyncedIterator;
import com.tzy.query.expression.VariableIterator.SetOperator;
import com.tzy.query.filter.TagVFilter;
import com.tzy.query.pojo.Expression;
import com.tzy.query.pojo.Filter;
import com.tzy.query.pojo.Metric;
import com.tzy.query.pojo.Output;
import com.tzy.query.pojo.Query;
import com.tzy.query.pojo.Timespan;
import com.tzy.stats.QueryStats;
import com.tzy.uid.NoSuchUniqueName;
import com.tzy.uid.UniqueId.UniqueIdType;
import com.tzy.utils.DateTime;
...
public class QueryExecutor {
  ...
  public void execute(final HttpQuery query) {
     ...
     */
    class BuildCB implements Callback<Deferred<Object>, com.tzy.core.Query[]> {
      @Override
      public Deferred<Object> call(final com.tzy.core.Query[] queries) {
        final ArrayList<Deferred<DataPoints[]>> deferreds = 
            new ArrayList<Deferred<DataPoints[]>>(queries.length);
        
        for (final com.tzy.core.Query query : queries) {
