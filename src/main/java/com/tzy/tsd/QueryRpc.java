...
import com.tzy.core.IncomingDataPoint;
import com.tzy.core.Query;
import com.tzy.core.QueryException;
import com.tzy.core.RateOptions;
...
import com.tzy.meta.TSUIDQuery;
import com.tzy.query.expression.ExpressionTree;
import com.tzy.query.expression.Expressions;
...
final class QueryRpc implements HttpRpc {
  ...
  private void handleExpressionQuery(final TSDB tsdb, final HttpQuery query) {
    final com.tzy.query.pojo.Query v2_query =
        JSON.parseToObject(query.getContent(), com.tzy.query.pojo.Query.class);
    v2_query.validate();
